...
pub const COIN_NAME: &str = "Free Web Movement Coin - Zero Trust Zero Governance";
pub const COIN_SYMBOL: &str = "FWMC-ZZ";
pub const COIN_DECIMALS: u8 = 8; // 1 Zz = 0.00000001 USD
